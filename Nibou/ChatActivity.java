...
public class ChatActivity extends BaseActivity {
    ...
    public void initTimer() {
        ...
        Glide.with(context).load(R.drawable.radio_button).asGif().into(((ImageView) binding.toolbar.findViewById(R.id.timer_image)));
        TimerUtil.getTimerUtil().startTimer(new TimerUtil.TimerCallback() {
