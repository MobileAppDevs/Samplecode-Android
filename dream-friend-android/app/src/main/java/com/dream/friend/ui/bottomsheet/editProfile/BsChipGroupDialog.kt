...
class BsChipGroupDialog(
    var title: String,
    var list: ArrayList<String>,
    var alreadySelectedList: ArrayList<String>,
    var isMultiSelectEnabled: Boolean? = false,
    var listener: ChipGroupListener
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.bottomsheet_sub_chip_group, container, false)
        ...
        chipGroup.setOnCheckedStateChangeListener { group, checkedIds ->
            ...
            if(count<6) {
                ...
                checkedIds.map { checkedIndex ->
                    ...
                    view.findViewById<MaterialButton>(R.id.btnApplyFilters).text="Apply $count/${if(isMultiSelectEnabled == true) 5 else 1}"
                }
        ...
        view.findViewById<MaterialButton>(R.id.btnApplyFilters).setOnClickListener {
            listener.onApplyBtnClicked(selectedChips)
            dismiss()
        }
