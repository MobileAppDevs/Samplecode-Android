package com.ongraph.whatsappclone.common.connectivity
...
import com.ongraph.whatsappclone.common.connectivity.base.ConnectivityProviderBaseImpl
import com.ongraph.whatsappclone.common.connectivity.base.ConnectivityProvider.NetworkState.ConnectedState.ConnectedLegacy
import com.ongraph.whatsappclone.common.connectivity.base.ConnectivityProvider.NetworkState.NotConnectedState
        ...
        override fun onReceive(c: Context, intent: Intent) {
            ...
            val state: ConnectivityProvider.NetworkState =
                if (networkInfo?.isConnectedOrConnecting == true) {
                    ...
                    if (state != null) ConnectedLegacy(
                        state
                    ) else NotConnectedState
                }
